#!/usr/bin/env node
/**
 * Build ED-PLG into dist/EDPLG for copying into the EDMC plugins folder.
 *
...
const outputDir = path.join(root, "dist", "EDPLG");
...
console.log(`Built ED-PLG v${version ?? "?"} -> ${outputDir}`);
console.log("");
console.log("Copy to EDMC plugins folder:");
console.log("  %LOCALAPPDATA%\\EDMarketConnector\\plugins\\EDPLG");
